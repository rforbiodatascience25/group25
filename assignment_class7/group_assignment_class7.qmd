...
Data for processing is loaded and prepared for analysis.
...
pca_fit_few <- gravier_clean_aug |> 
  select('g2E09','g7F07','g1A01','g3C09','g3H08','g1A08',
         'g1B01','g1int1','g1E11','g8G02') |>  #  first 10 gene columns
  prcomp(scale = TRUE) # do PCA on scaled data
...
Subsets of data were prepared and saved for PCA analysis
